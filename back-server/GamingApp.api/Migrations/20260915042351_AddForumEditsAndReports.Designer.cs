...
namespace GamingApp.api.Migrations
{
    ...
    [Migration("20260915042351_AddForumEditsAndReports")]
    partial class AddForumEditsAndReports
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GamingApp.api.Models.ForumReply", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("GamingApp.api.Models.GameReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("GamingApp.api.Models.ForumReply", b =>
                {
                    ...
                    b.HasOne("GamingApp.api.Models.ForumTopic", null)
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("GamingApp.api.Models.PlayerProfile", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", null)
                        .WithOne()
                        .HasForeignKey("GamingApp.api.Models.PlayerProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
